...
namespace HotelManagement {
    ...
    public partial class QuanLyKhachSanDataSet : global::System.Data.DataSet {
        ...
        public partial class customerDataTable : global::System.Data.TypedTableBase<customerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public customerRow AddcustomerRow(int Id, string fname, string lname, string phone, string address, string email) {
...
namespace HotelManagement.QuanLyKhachSanDataSetTableAdapters {
    ...
    public partial class customerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[customer] WHERE (([Id] = @Original_Id) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [lname] IS NULL) OR ([lname] = @Original_lname)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[customer] ([Id], [fname], [lname], [phone], [address], [email]" +
                ") VALUES (@Id, @fname, @lname, @phone, @address, @email);\r\nSELECT Id, fname, lna" +
                "me, phone, address, email FROM customer WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[customer] SET [Id] = @Id, [fname] = @fname, [lname] = @lname, [phone] = @phone, [address] = @address, [email] = @email WHERE (([Id] = @Original_Id) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [lname] IS NULL) OR ([lname] = @Original_lname)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)));
SELECT Id, fname, lname, phone, address, email FROM customer WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, fname, lname, phone, address, email FROM dbo.customer";
        ...
        public virtual int Fill(QuanLyKhachSanDataSet.customerDataTable dataTable) {
        ...
        public virtual QuanLyKhachSanDataSet.customerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyKhachSanDataSet.customerDataTable dataTable = new QuanLyKhachSanDataSet.customerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyKhachSanDataSet.customerDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_fname, string Original_lname, string Original_phone, string Original_address, string Original_email) {
        ...
        public virtual int Insert(int Id, string fname, string lname, string phone, string address, string email) {
        ...
        public virtual int Update(int Id, string fname, string lname, string phone, string address, string email, int Original_Id, string Original_fname, string Original_lname, string Original_phone, string Original_address, string Original_email) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fname, string lname, string phone, string address, string email, int Original_Id, string Original_fname, string Original_lname, string Original_phone, string Original_address, string Original_email) {
            return this.Update(Original_Id, fname, lname, phone, address, email, Original_Id, Original_fname, Original_lname, Original_phone, Original_address, Original_email);
        }
    }
