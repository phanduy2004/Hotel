...
namespace HotelManagement {
    ...
    public partial class QuanLyKhachSanDataSet2 : global::System.Data.DataSet {
        ...
        public partial class roomDataTable : global::System.Data.TypedTableBase<roomRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public roomRow AddroomRow(int id, string roomtype, string bebtype, int price, int status) {
        ...
        public partial class roomRow : global::System.Data.DataRow {
            ...
            public string bebtype {
                get {
                    try {
                        return ((string)(this[this.tableroom.bebtypeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'bebtype\' in table \'room\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableroom.bebtypeColumn] = value;
                }
            }
            ...
            public bool IsbebtypeNull() {
                return this.IsNull(this.tableroom.bebtypeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetbebtypeNull() {
                this[this.tableroom.bebtypeColumn] = global::System.Convert.DBNull;
            }
...
namespace HotelManagement.QuanLyKhachSanDataSet2TableAdapters {
    ...
    public partial class roomTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[room] WHERE (([id] = @Original_id) AND ((@IsNull_roomtype = 1 AND [roomtype] IS NULL) OR ([roomtype] = @Original_roomtype)) AND ((@IsNull_bebtype = 1 AND [bebtype] IS NULL) OR ([bebtype] = @Original_bebtype)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[room] ([id], [roomtype], [bebtype], [price], [status]) VALUES " +
                "(@id, @roomtype, @bebtype, @price, @status);\r\nSELECT id, roomtype, bebtype, pric" +
                "e, status FROM room WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[room] SET [id] = @id, [roomtype] = @roomtype, [bebtype] = @bebtype, [price] = @price, [status] = @status WHERE (([id] = @Original_id) AND ((@IsNull_roomtype = 1 AND [roomtype] IS NULL) OR ([roomtype] = @Original_roomtype)) AND ((@IsNull_bebtype = 1 AND [bebtype] IS NULL) OR ([bebtype] = @Original_bebtype)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)));
SELECT id, roomtype, bebtype, price, status FROM room WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, roomtype, bebtype, price, status FROM dbo.room";
        ...
        public virtual int Fill(QuanLyKhachSanDataSet2.roomDataTable dataTable) {
        ...
        public virtual QuanLyKhachSanDataSet2.roomDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyKhachSanDataSet2.roomDataTable dataTable = new QuanLyKhachSanDataSet2.roomDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyKhachSanDataSet2.roomDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_roomtype, string Original_bebtype, global::System.Nullable<int> Original_price, global::System.Nullable<int> Original_status) {
            ...
            if ((Original_bebtype == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_bebtype));
            }
        ...
        public virtual int Insert(int id, string roomtype, string bebtype, global::System.Nullable<int> price, global::System.Nullable<int> status) {
            ...
            if ((bebtype == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(bebtype));
            }
        ...
        public virtual int Update(int id, string roomtype, string bebtype, global::System.Nullable<int> price, global::System.Nullable<int> status, int Original_id, string Original_roomtype, string Original_bebtype, global::System.Nullable<int> Original_price, global::System.Nullable<int> Original_status) {
            ...
            if ((bebtype == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(bebtype));
            }
            if ((price.HasValue == true)) {
            ...
            if ((Original_bebtype == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_bebtype));
            }
            if ((Original_price.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string roomtype, string bebtype, global::System.Nullable<int> price, global::System.Nullable<int> status, int Original_id, string Original_roomtype, string Original_bebtype, global::System.Nullable<int> Original_price, global::System.Nullable<int> Original_status) {
            return this.Update(Original_id, roomtype, bebtype, price, status, Original_id, Original_roomtype, Original_bebtype, Original_price, Original_status);
        }
    }
